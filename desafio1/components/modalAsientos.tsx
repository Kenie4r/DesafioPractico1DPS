...
export default function  ModalAsientos(//{movieTheather, closeDetails} : ModalAsientos
    ...
    useEffect(() => {
        dispatch(iniciarReserva({
            ...
            hour: salaSeleccionada.hour,
            total: 0
        }));
    }, [dispatch, salaSeleccionada.movieId, salaSeleccionada.MovieTheaterNumber, salaSeleccionada.hour]);
    ...
    return (
        <div className="fixed bg-gray-800/50 w-full h-full top-0 rigth-0
            ...
            <div className=" relative w-11/12  gap-2 bg-white h-hv rounded-lg shadow-xl m-4 "> 
                ...
                <button type="button" className="absolute top-0 left-0 text-lg p-4 hover:cursor-pointer" onClick={cerrarSeleccion}>
